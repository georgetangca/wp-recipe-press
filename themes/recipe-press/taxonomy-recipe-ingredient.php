...
<div id="container">
     <div id="content" role="main">
          ...
          <h1 class="page-title"><?php printf(__('Recipes that include %1$s:', 'recipe-press'), $term->name); ?></h1>
          ...
          <div class="recipe-press-categories">
               <ul id="recipe_taxonomy_list" class="recipe-press-taxonomy-list">
                    <li class="cat-item cat-intro"><?php _e('Ingredient Cloud: ', 'recipe-press'); ?></li>
