     ...
     <table id="recipe_box_list" class="recipe-box-list">
          ...
          <tbody>
               <?php if ( $recipeData->posts->have_posts() ) : while ($recipeData->posts->have_posts()) : $recipeData->posts->the_post(); ?>
                         ...
                         <td><?php the_recipe_box_notes_link(); ?><br>
                         <span id="recipe_notes_<?php the_id(); ?>" style="display: none">
                              <?php _e('Recipe Notes', 'recipe-press'); ?><br>
               ...
               <?php else:?>
                <tr> 
                   <td colspan="4"><?php _e('Box is empty now', 'recipe-press'); ?></td>
                </tr>
               <?php  endif; ?>
          </tbody>
     </table>
