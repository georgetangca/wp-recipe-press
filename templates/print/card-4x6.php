...
/**
 * card-4x6.php - The Template for printing a recipe on a 4x6 card.
 *
 * @package RecipePress
...
<div id="post-<?php echo $post->post_name; ?>" class="card-4x6">

     <div class="recipe-header">
          <div class="recipe-press-image align-right">
               <?php
               if ( function_exists('has_post_thumbnail') && has_post_thumbnail($post->ID) ) {
                    echo get_the_post_thumbnail($post->ID, array(125, 125));
               }
               ?>
          </div>
